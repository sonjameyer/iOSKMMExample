...
__attribute__((swift_name("Convert")))
@interface SKMMConvert : SKMMBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (double)ounceToGramOunces:(double)ounces __attribute__((swift_name("ounceToGram(ounces:)")));
- (double)ounceToMlOunces:(double)ounces __attribute__((swift_name("ounceToMl(ounces:)")));
- (double)poundToGramPounds:(double)pounds __attribute__((swift_name("poundToGram(pounds:)")));
@end;
